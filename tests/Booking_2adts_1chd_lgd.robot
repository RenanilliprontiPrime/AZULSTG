...
Caso de Testes 01 - Validar compra de passagens 3 pax (2Adt's e 1 Chd) no site
    [Documentation]    Realizar compra de reserva nacional com cliente "TudoAzul" logado, para pax "ADT" em "reais", com tarifa "Azul", somente IDA, 
	...                sem serviços adicionais e com pagamento no cartão de crédito "à vista" 
    [Tags]             BOOKING DOMÉSTICO
    [Setup]            inicia o teste com login  USER=Tudo Azul
    Dado que o cliente esteja com o destino de voo selecionado, data, forma de pagamento em Reais e passageiros 
